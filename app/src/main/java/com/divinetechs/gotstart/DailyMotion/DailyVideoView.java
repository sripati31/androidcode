...
public class DailyVideoView extends WebView {
    ...
    public DailyVideoView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public DailyVideoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init(){
        ...
        mRootLayout = (FrameLayout) ((AppCompatActivity) getContext()).getWindow().getDecorView();
    ...
    public void hideVideoView(){
        if(isFullscreen()){
            ...
            ((AppCompatActivity) getContext()).setVolumeControlStream(AudioManager.USE_DEFAULT_STREAM_TYPE);
            mIsFullscreen = false;
        }
    ...
    private void setupVideoLayout(View video){
        ...
        mVideoLayout.setBackgroundResource(R.color.colorAccent);
    ...
    public void handleBackPress(AppCompatActivity activity) {
        if(isFullscreen()){
            hideVideoView();
        } else {
