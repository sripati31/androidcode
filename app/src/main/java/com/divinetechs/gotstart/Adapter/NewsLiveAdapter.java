...
public class NewsLiveAdapter extends RecyclerView.Adapter<NewsLiveAdapter.MyViewHolder> {
    ...
    public NewsLiveAdapter(Context context, List<Result> PopularList, String status) {
